    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="px-6 py-4 whitespace-nowrap">{{ $email->message }}</td>
                <td class="px-6 py-4 whitespace-nowrap">
                    <button  style="background-color: #E51C1C"
                        class="text-white px-4 py-2 rounded-md mr-2 w-32 h-full">Eliminar</button>
                </td>
            </tr>
            @endforeach
        </tbody>
