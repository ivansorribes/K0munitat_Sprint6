            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <td class="px-6 py-4">
                        ...
                        <button onclick="showMore(event, '{{ $message->sender_name }}', '{{ $message->sender_email }}', '{{ $message->phone }}')" class="text-green-600">
                            Show More
                        </button>
                    </td>
                </tr>
    ...
    <div class="bg-white p-8 rounded shadow-md max-w-2xl overflow-y-auto" style="max-height: 80vh;">
        ...
        <form id="replyForm" action="{{ route('reply.message') }}" method="POST">
            ...
            <div class="mt-4 flex justify-end">
                ...
                <button type="button" onclick="closeShowMoreModal()" class="bg-gray-500 text-white px-4 py-2 rounded-md">Cancel</button>
            </div>
        </form>
    </div>
</div>
...
<script>
    ...
    function showMore(event, senderName, senderEmail, senderPhone, message) {
        event.stopPropagation();
