...
export default function EditPersonalProfile() {
    ...
    const saveUserInfo = async () => {
        try {
            ...
            if (selectedImage) {
                // Si se seleccionó una nueva imagen, agregala al formulario
            ...
            if (response.ok) {
                ...
                // Actualizar la imagen fuera del modal
    ...
    const changePassword = async () => {
        try {
            ...
            if (response.ok) {
                ...
                setPasswordModalOpen(false); // Cerrar el modal después de cambiar la contraseña
            } else {
                // Si hay un error, mostrar el mensaje de error devuelto por el servidor
